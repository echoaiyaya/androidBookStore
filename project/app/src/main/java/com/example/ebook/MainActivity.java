    ...
    private void initBooks() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            Book b3 = new Book("The Fifth Season Paperback – Aug. 4 2015", R.drawable.book4, "N. K. Jemisin", "\"Intricate and extraordinary.\" - New York Times on The Fifth Season (A New York Times Notable Book of 2015)\n" +
                    "\n" +
                    "The start of a new fantasy trilogy by Hugo, Nebula & World Fantasy Award nominated author N.K. Jemisin.", 16.23, type, "book3" + i);
            ...
            Book b5 = new Book("D&D Waterdeep Dragon Heist HC Hardcover – Illustrated, Sept. 18 2018", R.drawable.book6, "Wizards RPG Team", "Experience the ultimate urban treasure hunt in this adventure for the world’s greatest roleplaying game.\n" +
                    ...
                    " \n" +
                    "“Waterdeep: Dragon Heist is a shining example of what Dungeons & Dragons can be and should be: fun and unpredictable.”—Gavin Sheehan, BleedingCool.com", 45.70, type, "book5" + i);
            Book b6 = new Book("hello6", R.drawable.book1, "jinqian", "good book", 23.23, type, "book6" + i);
            Book b7 = new Book("hello7", R.drawable.book1, "jinqian", "good book", 23.23, type, "book7" + i);
            Book b8 = new Book("hello8", R.drawable.book1, "jinqian", "good book", 23.23, type, "book8" + i);
            Book b9 = new Book("hello9", R.drawable.book1, "jinqian", "good book", 23.23, type, "book9" + i);
//            bookList.add(b1);
//            bookList.add(b2);
//            bookList.add(b3);
//            bookList.add(b4);
